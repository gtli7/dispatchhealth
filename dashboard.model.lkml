...
include: "athena_patientpastmedicalhistory.view.lkml"
...
join: athena_patient_medical_history {
  ...
  join: athena_comorbidity_category {
    relationship: one_to_many
    from: athena_patientpastmedicalhistory
    sql_on: ${athena_clinicalencounter.chart_id} = ${athena_comorbidity_category.chart_id} ;;
    fields: [athena_comorbidity_category.comorbidity_category,
      athena_comorbidity_category.count_distinct_charts,
      athena_comorbidity_category.count_positive_responses,
      athena_comorbidity_category.answer,
      athena_comorbidity_category.answer_yes]
  }
...
join: athena_document_results {
  relationship: one_to_many
  sql_on: ${athena_document_orders.document_results_document_id} = ${athena_document_results.document_id} ;;
}
...
join: athena_result_created {
  ...
  sql_on:  ${athena_document_orders.document_results_document_id} = ${athena_result_created.document_id};;
  # fields: []
}

join: athena_result_closed {
  relationship: one_to_one
  sql_on: ${athena_document_orders.document_results_document_id} = ${athena_result_closed.document_id} ;;
  # fields: []
}
...
join: athena_result_documentaction {
  ...
  relationship: one_to_many
  sql_on: ${athena_document_orders.document_results_document_id} = ${athena_result_documentaction.document_id} ;;
}
...
join: document_result_last_action {
  ...
  relationship: one_to_one
  sql_on: ${athena_document_orders.document_results_document_id} = ${document_result_last_action.document_id} ;;
}

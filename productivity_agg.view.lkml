...
view: productivity_agg {
  ...
  dimension: name_adj {
    ...
    drill_fields: [granular_shift_tracking_agg.app_car_staff,granular_shift_tracking_agg.dhmt_car_staff, granular_shift_tracking_agg.car_name, granular_shift_tracking_agg.shift_team_id ]

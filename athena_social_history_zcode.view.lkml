  ...
  sql: SELECT
          ...
          CASE WHEN social_history_key = 'SOCIALHISTORY.LOCAL.91' AND (social_history_answer LIKE 'I Have Housing Today But%' OR
            ...
            social_history_answer LIKE 'Needs %') THEN 'Z59.1'
                WHEN (social_history_key = 'SOCIALHISTORY.LOCAL.145' AND (social_history_answer = 'Y')) THEN 'Z91.81'
                WHEN (social_history_key = 'SOCIALHISTORY.LOCAL.146' AND (social_history_answer = 'Y')) THEN 'Z91.81'
                WHEN (social_history_key = 'SOCIALHISTORY.LOCAL.147' AND (social_history_answer = 'Y')) THEN 'Z91.81'
                ...
                WHEN (social_history_key = 'SOCIALHISTORY.LOCAL.142' AND (social_history_answer = 'Yes%')) THEN 'Z59.4'
                ...
                WHEN (social_history_key = 'SOCIALHISTORY.LOCAL.144' AND (social_history_answer = 'Y')) THEN 'Z74.1'
          ELSE NULL
          END AS z_code
        ...
        WHERE (social_history_key = 'SOCIALHISTORY.LOCAL.91' AND (social_history_answer LIKE 'I Have Housing Today But%' OR
            ...
            OR (social_history_key = 'SOCIALHISTORY.LOCAL.145' AND (social_history_answer = 'Y'))
            OR (social_history_key = 'SOCIALHISTORY.LOCAL.146' AND (social_history_answer = 'Y'))
            OR (social_history_key = 'SOCIALHISTORY.LOCAL.147' AND (social_history_answer = 'Y'))
            ...
            OR (social_history_key = 'SOCIALHISTORY.LOCAL.142' AND (social_history_answer = 'Yes%'))
            ...
            OR (social_history_key = 'SOCIALHISTORY.LOCAL.144' AND (social_history_answer = 'Y'))
      ;;
